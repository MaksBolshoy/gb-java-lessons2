...
public abstract class Character {
    public Character(String name, model.base.Weapon weapon, Armor armor) {
        this.name = name;
        this.wp = weapon;
        this.armor = armor;
        level = 0;
    ...
    public Character(String name, Weapon weapon, oop.homework.hw7.Armor armor) {
    }
    ...
    public model.base.Weapon getWeapon() {
        return wp;
    }
    ...
    private model.base.Weapon wp = new Hands();
